...
SEARCH_TREE_BASE::SEARCH_TREE_BASE( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : wxPanel( parent, id, pos, size, style )
{
	...
	m_searchSizer->Add( m_staticFilterText, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	...
	m_tree = new wxTreeCtrl( this, wxID_SEARCHABLE_TREE, wxDefaultPosition, wxDefaultSize, style);
	...
	m_labels->Add( m_staticDefaultText, 1, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	...
	m_tree->Connect( wxEVT_LEFT_DOWN, wxMouseEventHandler( SEARCH_TREE_BASE::OnLeftDown ), NULL, this );
	m_tree->Connect( wxEVT_RIGHT_DOWN, wxMouseEventHandler( SEARCH_TREE_BASE::OnRightClick ), NULL, this );
}
...
SEARCH_TREE_BASE::~SEARCH_TREE_BASE()
{
	...
	m_tree->Disconnect( wxEVT_LEFT_DOWN, wxMouseEventHandler( SEARCH_TREE_BASE::OnLeftDown ), NULL, this );
	m_tree->Disconnect( wxEVT_RIGHT_DOWN, wxMouseEventHandler( SEARCH_TREE_BASE::OnRightClick ), NULL, this );
