...
public:
    ...
    /// @copydoc GRAPHICS_ABSTRACTION_LAYER::Flush()
    virtual void Flush();
    ...
    /// @copydoc GRAPHICS_ABSTRACTION_LAYER::Rotate()
    virtual void Rotate( double aAngle );

    /// @copydoc GRAPHICS_ABSTRACTION_LAYER::Translate()
    virtual void Translate( VECTOR2D aTranslation );

    /// @copydoc GRAPHICS_ABSTRACTION_LAYER::Scale()
    ...
    /// @copydoc GRAPHICS_ABSTRACTION_LAYER::ComputeWorldScreenMatrix()
    virtual void ComputeWorldScreenMatrix();

    /// @copydoc GRAPHICS_ABSTRACTION_LAYER::GetWorldScreenMatrix()
    MATRIX3x3D GetWorldScreenMatrix();

    /// @copydoc GRAPHICS_ABSTRACTION_LAYER::SetWorldScreenMatrix()
...
private:
    ...
    wxMemoryDC* dc;                             ///< Pointer to a buffered DC
