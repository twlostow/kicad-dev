#ifndef __draw_panel_BASE_H
#define __draw_panel_BASE_H
...
typedef void ( *DP_MOUSE_CAPTURE_CALLBACK )( DRAW_PANEL_BASE* aPanel, wxDC* aDC,
                                          const wxPoint& aPosition, bool aErase );

/**
 * End mouse capture callback function prototype.
 */
typedef void ( *DP_END_MOUSE_CAPTURE_CALLBACK )( DRAW_PANEL_BASE* aPanel, wxDC* aDC );
...
protected:
    ...
    DP_MOUSE_CAPTURE_CALLBACK m_mouseCaptureCallback;

    /// Abort mouse capture callback function.
    DP_END_MOUSE_CAPTURE_CALLBACK m_endMouseCaptureCallback;
...
public:
     ...
     */
    virtual void SetMouseCapture( DP_MOUSE_CAPTURE_CALLBACK aMouseCaptureCallback,
                          DP_END_MOUSE_CAPTURE_CALLBACK aEndMouseCaptureCallback )
    {
    ...
    virtual void SetMouseCaptureCallback( DP_MOUSE_CAPTURE_CALLBACK aMouseCaptureCallback )
    {
        m_mouseCaptureCallback = aMouseCaptureCallback;
    }
