...
class EDA_TEXT 
{
    ...
    public:
        ...
        void SetDefaultSize( const wxSize& aNewSize ); 
        void SetDefaultSize( const int aNewSize )
        {
            SetDefaultSize( wxSize ( aNewSize, aNewSize) );
        }
         ...
         */
        virtual void Format( OUTPUTFORMATTER* aFormatter, UNITS *aUnits, int aNestLevel, int aControlBits ) const
            throw( IO_ERROR );
