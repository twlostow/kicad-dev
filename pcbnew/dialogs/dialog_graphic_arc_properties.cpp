...
DIALOG_GRAPHIC_ARC_PROPERTIES::DIALOG_GRAPHIC_ARC_PROPERTIES( PCB_BASE_FRAME* aParent,
    ...
    m_centerX( aParent, m_centerXCtrl, m_centerXUnit ),
    m_centerY( aParent, m_centerYCtrl, m_centerYUnit ),
    m_radius( aParent, m_radiusCtrl, m_radiusUnit ),
    m_width( aParent, m_widthCtrl, m_widthUnit ),
    m_startAngle( aParent, m_startAngleCtrl, m_startAngleUnit, nullptr, DEGREES ),
    m_centralAngle( aParent, m_centralAngleCtrl, m_centralAngleUnit, nullptr, DEGREES )
{
...
bool DIALOG_GRAPHIC_ARC_PROPERTIES::Apply( COMMIT& aCommit )
{
    ...
    for( auto item : m_items )
    {
        ...
        case ADM_BY_ANGLES:
        {
            ...
            int radius = m_radius.Valid() ? m_radius.GetValue() : ds->GetRadius();
            double startAngle =
                m_startAngle.Valid() ? m_startAngle.GetValueDbl() : ds->GetArcAngleStart();
            double centralAngle =
                m_centralAngle.Valid() ? m_centralAngle.GetValueDbl() : ds->GetAngle();
