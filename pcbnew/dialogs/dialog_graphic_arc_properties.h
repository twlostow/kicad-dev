...
#ifndef __DIALOG_GRAPHIC_ARC_PROPERTIES_H_
#define __DIALOG_GRAPHIC_ARC_PROPERTIES_H_
...
private:
    ...
    UNIT_BINDER m_centerX, m_centerY;
    UNIT_BINDER m_radius;
    UNIT_BINDER m_width;
    UNIT_BINDER m_startAngle, m_centralAngle;
