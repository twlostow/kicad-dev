...
DIALOG_GRAPHIC_ARC_PROPERTIES_BASE::DIALOG_GRAPHIC_ARC_PROPERTIES_BASE( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : DIALOG_SHIM( parent, id, title, pos, size, style )
{
	...
	m_sizer1 = new wxFlexGridSizer( 4, 7, 0, 0 );
	m_sizer1->AddGrowableCol( 7 );
	...
	m_sizer2 = new wxFlexGridSizer( 4, 6, 0, 0 );
	m_sizer2->AddGrowableCol( 7 );
	...
	m_sizer2->Add( m_startXCtrl, 1, wxALIGN_CENTER_VERTICAL|wxBOTTOM|wxLEFT|wxTOP|wxEXPAND, 5 );
	...
	m_sizer2->Add( m_startYCtrl, 0, wxALIGN_CENTER_VERTICAL|wxBOTTOM|wxLEFT|wxTOP, 5 );
	...
	m_sizer2->Add( m_endXCtrl, 1, wxALIGN_CENTER_VERTICAL|wxEXPAND|wxTOP|wxBOTTOM|wxLEFT, 5 );
	...
	m_sizer2->Add( m_centerYCtrl, 0, wxALL, 5 );
	...
	m_sizer2->Add( m_radiusCtrl, 0, wxTOP|wxBOTTOM|wxLEFT, 5 );
	...
	m_sizer2->Add( m_centralAngleUnit, 0, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5 );
	
	
	bMainSizer->Add( m_sizer2, 1, wxEXPAND|wxBOTTOM, 5 );
