...
#include <dialogs/dialog_linear_constraint_properties_base.h>

class DIALOG_LINEAR_CONSTRAINT_PROPERTIES : public DIALOG_LINEAR_CONSTRAINT_PROPERTIES_BASE
{
public:
    DIALOG_LINEAR_CONSTRAINT_PROPERTIES( PCB_BASE_FRAME* aParent, const SELECTION& aItems );
