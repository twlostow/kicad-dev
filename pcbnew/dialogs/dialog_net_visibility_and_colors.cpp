...
public:
    ...
    void Add( NETCLASSPTR aNetclass, const COLOR4D& aDefaultColor  )
    {
        ...
        auto child_node =
            new NET_COLOR_NODE( m_classes, aNetclass->RatsnestPrefs(), aDefaultColor, aNetclass->GetName() );
    ...
    void Add( NETINFO_ITEM* aItem, const COLOR4D& aDefaultColor  )
    {
        ...
        auto child_node =
            new NET_COLOR_NODE( m_nets, aItem->RatsnestPrefs(), aDefaultColor, aItem->GetShortNetname() );
