...
/**
 * Function InvokeDialogBoardGfxBoard
 * shows the modal DIALOG_IMPORT_GFX for importing a vector graphics file to a board.
...
/**
 * Function InvokeDialogBoardGfxModule
 * shows the modal DIALOG_IMPORT_GFX for importing a vector graphics file as footprint outlines.
 *
 * @param aCaller is the wxTopLevelWindow which is invoking the dialog.
