...
static wxMenu* Append_Track_Width_List( BOARD* aBoard )
{
    ...
    {
        value = g_PcbUnits.StringFromValue( aBoard->m_TrackWidthList[ii], true );
    ...
    {
        value = g_PcbUnits.StringFromValue( aBoard->m_ViasDimensionsList[ii].m_Diameter,
                                       true );
        wxString drill = g_PcbUnits.StringFromValue(
