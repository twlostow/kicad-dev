...
PNS_LOG_VIEWER_FRAME_BASE::PNS_LOG_VIEWER_FRAME_BASE( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_rewindLeft->SetMaxSize( wxSize( 30,-1 ) );
	...
	m_rewindRight->SetMaxSize( wxSize( 30,-1 ) );
	...
	wxArrayString m_itemListChoices;
	m_itemList = new wxCheckListBox( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, m_itemListChoices, 0 );
	bSizer6->Add( m_itemList, 0, wxALL, 5 );
	
	
	m_mainSizer->Add( bSizer6, 0, wxEXPAND, 5 );
